         ...
         <table>
            ...
            >
               ...
               <td>
                  ...
                  >
                     <slot>Obtiene Link</slot>
                  </px-button>
                  <a class="hover:underline text-green-600" target="_blank">{{
                     m.url
                  }}</a>
               </td>
            </tr>
...
export default {
   name: 'CoinDetail',
   components: { RingLoader, PxButton },
   ...
   methods: {
      ...
      getWebSite(exchange) {
         // this.$set(this.exchange, 'isLoading', true)
         return api
            ...
            .finally(() => {
               // this.$set(this.exchange, 'isLoading', false)
            })
      },
      getCoin() {
